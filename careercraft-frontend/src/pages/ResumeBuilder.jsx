...
import { Download, FileText, Plus, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      case 1: // Summary
        return (
          <div className="space-y-4">
            ...
            <textarea 
              placeholder="Write a brief overview of your professional background, skills, and career goals (2-3 sentences recommended)"
      ...
      case 4: // Skills
        return (
          <div className="space-y-4">
            ...
            <textarea
              placeholder="List your skills separated by commas (e.g., JavaScript, React, Node.js, Python, AWS, Project Management)"
              value={resume.skills}
        ...
        return (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <button 
                onClick={() => addArrayItem('projects', { name: "", description: "", tech: "" })} 
                className="btn-primary flex items-center space-x-2 text-sm"
              >
                <Plus className="h-4 w-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Professional Resume Builder</h1>
              <p className="text-gray-600">Create a resume ready for company submission</p>
            </div>
          </div>
                ...
                {steps.map((stepName, index) => (
                  <div key={stepName} className="flex items-center">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                      ...
                      index < step ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-600'
                    }`}>
                      {index + 1}
                    </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-6">
              <div className="card p-4 mb-4">
                ...
                <p className="text-sm text-gray-600">Real-time resume preview</p>
              </div>

              <div ref={previewRef} className="card p-6 bg-white">
                {/* Professional Resume Preview */}
                <div className="text-center mb-6">
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">{resume.name || "Your Name"}</h1>
                  {resume.title && <p className="text-lg text-blue-600 font-medium mb-3">{resume.title}</p>}
                ...
                {resume.summary && (
                  <section className="mb-6">
                    <h2 className="text-lg font-semibold text-gray-900 border-b-2 border-blue-500 pb-1 mb-3">PROFESSIONAL SUMMARY</h2>
                ...
                {resume.experience && resume.experience[0]?.company && (
                  <section className="mb-6">
                    <h2 className="text-lg font-semibold text-gray-900 border-b-2 border-blue-500 pb-1 mb-3">EXPERIENCE</h2>
                    {resume.experience.map((exp, index) => (
                      exp.company && (
                ...
                {resume.education && resume.education[0]?.institution && (
                  <section className="mb-6">
                    <h2 className="text-lg font-semibold text-gray-900 border-b-2 border-blue-500 pb-1 mb-3">EDUCATION</h2>
                    {resume.education.map((edu, index) => (
                      edu.institution && (
                ...
                {resume.skills && (
                  <section className="mb-6">
                    <h2 className="text-lg font-semibold text-gray-900 border-b-2 border-blue-500 pb-1 mb-3">SKILLS</h2>
                ...
                {resume.projects && resume.projects[0]?.name && (
                  <section>
                    <h2 className="text-lg font-semibold text-gray-900 border-b-2 border-blue-500 pb-1 mb-3">PROJECTS</h2>
                    {resume.projects.map((project, index) => (
                      project.name && (
                        <div key={index} className="mb-4">
                          <h3 className="font-semibold text-gray-900">{project.name}</h3>
                          <p className="text-gray-700 text-sm mb-1">{project.description}</p>
                          {project.tech && <p className="text-blue-600 text-sm">Technologies: {project.tech}</p>}
                        </div>
                      )
                    ))}
                  </section>
